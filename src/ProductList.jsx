...
function ProductList({ onHomeClick }) {
    ...
    const [addedToCart, setAddedToCart] = useState([]); // items added to Cart
    ...
    const ifAddedToCart = (e) => {
        const item = cart.find((item) => item.name === e.name);
        return !!item;
    }
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        ...
                        <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="1em">
            ...
            {!showCart ? (
                ...
                {plantsArray.map((group, index) => 
                    <div key={group}>
                        <h1> <div className="underline-title">{group.category}</div> </h1>
                            ...
                            {group.plants.map((plant, plantIndex) => (
                                <div className="product-card" key={plantIndex}>
                                    ...
                                    <button className="product-button"
                                        ...
                                        disabled={ifAddedToCart(plant)}>
                                        {ifAddedToCart(plant) ? 'Added to Cart' : 'Add to Cart'}
                                    </button>
